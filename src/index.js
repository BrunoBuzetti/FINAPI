...
// app.use(verifyExistsAccountCPF); All routes after this will use the middleware
...
app.delete('/account', verifyExistsAccountCPF, (req, res) => {
  ...
  if (balance!==0) {
    return res.status(400).json({error:"Cannot delete an account with a balance other then zero."})
  }

  customers.splice(customers.indexOf(customer), 1);

  //return res.status(204); this is the normal, but we show the result for verify
...
app.listen(3333, () => console.log("Server is running (nodejs ignite)"));